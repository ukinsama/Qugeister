...
class GeisterGame:
    ...
    def make_move(self, from_pos, to_pos):
        ...
        if self.get_kind_of_piece(moving_piece_str) == GOOD_GHOST and (to_r, to_c) in (self.player_a_exits if self.current_player == sePLAYER_A_ID else self.player_b_exits):
