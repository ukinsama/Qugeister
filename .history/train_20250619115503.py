...
def run_geister_cqcnn_training(episodes=100, n_qbits=4, cnn_out_feat=4):
    ...
    input_channels = game_instance.get_state_channels() # 状態表現のチャネル数 (GeisterGame.get_state の出力に合わせる)
    ...
    eval_env_Q_vs_Random = Env_Geister(agent_a_q, RandomPolicy(PLAYER_B_ID, game_instance), game_instance_q)
